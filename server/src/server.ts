  ...
  connectionManager: ComposerConnectionManager
    ...
    return new Promise<Hapi.Server>(resolve => {
        ...
        Promise.all(pluginPromises).then(() => {
            ...
            Member.init(server, configs, database, hyperledger, logger, connectionManager);
            Documents.init(server, configs, database, hyperledger, logger, connectionManager);
            Category.init(server, configs, database, hyperledger, logger, connectionManager);
            Keys.init(server, configs, database, hyperledger, logger, connectionManager);
