...
export default class ComposerConnectionManager {
  ...
  static BUSINESS_NETWORK = 'quickkyc';
...
static CONNECTION_PROFILE = {
  ...
  importNewIdCard(userId: string, enrollmentSecret: string): Promise<any> {
    ...
    const idCard = new IdCard({ userName: userId, enrollmentSecret: enrollmentSecret, businessNetwork: ComposerConnectionManager.BUSINESS_NETWORK }, ComposerConnectionManager.CONNECTION_PROFILE_O);
